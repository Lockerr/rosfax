...
Функционал: Управление шедулями
  ...
  # Сценарий: уведомление администрации о появлении нового осмотра
  #   Допустим я создал шедулю на завтра для этой компании

  # Сценарий: уведомление администрации об изменении времени осмотра