...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { condition: @point.condition, object: @point.object, place: @point.place, report_id: @point.report_id, section: @point.section, state: @point.state }
    end
  ...
  test "should update point" do
    put :update, id: @point, point: { condition: @point.condition, object: @point.object, place: @point.place, report_id: @point.report_id, section: @point.section, state: @point.state }
    assert_redirected_to point_path(assigns(:point))
  end
